...
class APIs:
    ...
    def send_private_msg(self, user_id: int, message: str, group_id: int = False, auto_escape: bool = False) -> requests.Response:
        ...
        Response = requests.post(
            '{}/send_private_msg'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def send_group_msg(self, group_id: int, message: str, auto_escape: bool = False) -> requests.Response:
        ...
        Response = requests.post(
            '{}/send_group_msg'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def send_group_forward_msg(self, group_id: int, message: str) -> requests.Response:
        ...
        Response = requests.post(
            '{}/send_group_forward_msg'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def send_msg(self, message: str, user_id: int, group_id: int, message_type: str = None, auto_escape: bool = False) -> requests.Response:
        ...
        Response = requests.post(
            '{}/send_msg'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def get_msg(self, message_id: int) -> requests.Response:
        ...
        Response = requests.post(
            '{}/get_msg'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def get_forward_msg(self, message_id: int) -> requests.Response:
        ...
        Response = requests.post(
            '{}/get_forward_msg'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def get_image(self, file: str) -> requests.Response:
        ...
        Response = requests.post(
            '{}/get_image'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def mark_msg_as_read(self, message_id: int) -> requests.Response:
        ...
        Response = requests.post(
            '{}/mark_msg_as_read'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_group_kick(self, group_id: int, user_id: int, reject_add_request: bool = False) -> requests.Response:
        ...
        Response = requests.post(
            '{}/set_group_kick'.format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_group_ban(self, group_id: int, user_id: int, duration: int) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_group_ban".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_group_anonymous_ban(self, group_id: int, duration: int, anonymous_flag: str = False, anonymous: object = False) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_group_anonymous_ban".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_group_whole_ban(self, group_id: int, enable: bool = True) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_group_whole_ban".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_group_admin(self, group_id: int, user_id: int, enable: bool = True) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_group_admin".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_group_card(self, group_id: int, user_id: int, card: str) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_group_card".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def Set_Group_Name(self, group_id: int, group_name: str) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_group_name".format(self.Server), data=Date)
        return Response
    ...
    def set_group_leave(self, group_id: int, is_dismiss: bool = False) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_group_leave".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_group_special_title(self, group_id: int, user_id: int, special_title: str) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_group_special_title".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def send_group_sign(self, group_id: int) -> requests.Response:
        ...
        Response = requests.post(
            "{}/send_group_sign".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_friend_add_request(self, flag: str, approve: bool, remark: str = False) -> requests.Response:
        ...
        if remark:
            Date["remark"] = remark
        Response = requests.post(
            "{}/set_friend_add_request".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def set_group_add_request(self, flag: str, sub_type: str, approve: bool, reason: str = False) -> requests.Response:
        ...
        if reason:
            Date["reason"] = reason
        Response = requests.post(
            "{}/set_group_add_request".format(self.Server), data=Date, headers=self.headers)
        return Response

    def get_login_info(self) -> requests.Response:
        Response = requests.post(
            "{}/get_login_info".format(self.Server), headers=self.headers)
        return Response

    def didian_get_account_info(self) -> requests.Response:
        Response = requests.post(
            "{}/qidian_get_account_info".format(self.Server), headers=self.headers)
        return Response

    def get_friend_list(self) -> requests.Response:
        Response = requests.post(
            "{}/get_friend_list".format(self.Server), headers=self.headers)
        return Response

    def get_unidirectional_friend_list(self) -> requests.Response:
        Response = requests.post(
            "{}/get_unidirectional_friend_list".format(self.Server), headers=self.headers)
        return Response
    ...
    def set_qq_profile(self, nickname: str, company: str, email: str, college: str, personal_note: str) -> requests.Response:
        ...
        Response = requests.post(
            "{}/set_qq_profile".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def get_stranger_info(self, user_id: int, no_cache: bool = False) -> requests.Response:
        ...
        Response = requests.post(
            "{}/get_stranger_info".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def delete_friend(self, user_id: int) -> requests.Response:
        ...
        Response = requests.post(
            "{}/delete_friend".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def delete_msg(self, message_id: int) -> requests.Response:
        ...
        Response = requests.post(
            "{}/delete_msg".format(self.Server), data=Date, headers=self.headers)
        return Response
    ...
    def upload_group_file(self, group_id: int, file: str, name: str, folder: str = None) -> requests.Response:
        ...
        if folder:
            Date["folder"] = folder
        Response = requests.post(
            "{}/upload_group_file".format(self.Server), data=Date, headers=self.headers)
...
class Amap:
    ...
    def ip_positioning(self, ip: str) -> requests.Response:
        Response = requests.get(
            "https://restapi.amap.com/v3/ip?key={}&ip={}".format(self.key, ip))
        return Response

    def forecasters(self, city, extensions) -> requests.Response:
        Response = requests.get(
            "https://restapi.amap.com/v3/weather/weatherInfo?key={}&city={}&extensions={}".format(self.key, city, extensions))
        return Response
...
class OtherAPI:
    ...
    def chatgpt(self, msg: str, proxy: str = None) -> str:
        chatbot = Chatbot(self.chatgpt_token, proxy=proxy) if proxy else Chatbot(
            self.chatgpt_token)
    ...
    def image_generation(self, description: str) -> dict:
        Response = openai.Image.create(
            self.chatgpt_token, prompt=description, n=1, size="1024x1024")
        return Response

    def image_variation(self, img_path: pathlib.Path) -> dict:
        Response = openai.Image.create_variation(
            open(img_path, "rb"), self.chatgpt_token, n=1, size="1024x1024")
        return Response

    def search_github_repo(self, args: str) -> requests.Response:
        Response = requests.get(
            url="https://api.github.com/search/repositories?q={}".format(args), verify=self.verify)
        return Response

    def search_github_user(self, args: str) -> requests.Response:
        Response = requests.get(
            url="https://api.github.com/search/users?q={}".format(args), verify=self.verify)
        return Response

    def lookup_github_user(self, user: str) -> requests.Response:
        Response = requests.get(
            "https://api.github.com/users/{}/repos".format(user), verify=self.verify)
        return Response
    ...
    def random_image(self) -> requests.Response:
        ...
        Response = requests.get(
            url[random.randint(0, len(url)-1)], verify=self.verify)
        return Response
